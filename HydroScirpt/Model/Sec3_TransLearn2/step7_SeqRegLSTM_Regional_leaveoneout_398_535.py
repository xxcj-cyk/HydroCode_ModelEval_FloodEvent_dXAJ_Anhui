...
SUBSETS = {
    "398": {
        ...
        "output_dir": r"HydroScirpt/Result/Sec3_TransLearn2/SeqRegLSTM_Train_Anhui398",
        "max_workers": 5,
    },
    "535": {
        "input_path": f"{DATASET_ROOT}/Anhui18_535",
        "output_dir": r"HydroScirpt/Result/Sec3_TransLearn2/SeqRegLSTM_Train_Anhui535",
        "max_workers": 5,
    },
}
...
def run_subset(subset: str, test_mode: bool) -> tuple[int, int]:
    ...
    print("=" * 60)
    print(f"Sec3_TransLearn2 — SeqRegLSTM regional leaveoneout train Top9 (Anhui{subset})")
