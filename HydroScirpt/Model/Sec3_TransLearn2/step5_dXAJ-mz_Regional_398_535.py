...
PROJECT_PREFIX = "dXAJ-mz_Regional"
TOP9_CSV = (
    ROOT
...
SUBSETS = {
    "398": {
        ...
        "output_dir": r"HydroScirpt/Result/Sec3_TransLearn2/dXAJ-mz_Regional_Anhui398",
        "max_workers": 9,
    },
    "535": {
        "input_path": f"{DATASET_ROOT}/Anhui18_535",
        "output_dir": r"HydroScirpt/Result/Sec3_TransLearn2/dXAJ-mz_Regional_Anhui535",
        "max_workers": 9,
    },
}
...
def run_subset(subset: str, test_mode: bool) -> tuple[int, int]:
    ...
    print("=" * 60)
    print(f"Sec3_TransLearn2 — dXAJ-mz unified regional train Top9 (Anhui{subset})")
