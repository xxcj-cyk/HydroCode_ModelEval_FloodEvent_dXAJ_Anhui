...
SUBSETS = {
    "398": {
        ...
        "train_dir": ROOT / "HydroScirpt/Result/Sec3_TransLearn2/SeqRegLSTM_Train_Anhui398",
        "output_dir": r"HydroScirpt/Result/Sec3_TransLearn2/SeqRegLSTM_TransLearn_reuse_Anhui398",
        "max_workers": 10,
    },
    "535": {
        "input_path": f"{DATASET_ROOT}/Anhui18_535",
        "train_dir": ROOT / "HydroScirpt/Result/Sec3_TransLearn2/SeqRegLSTM_Train_Anhui535",
        "output_dir": r"HydroScirpt/Result/Sec3_TransLearn2/SeqRegLSTM_TransLearn_reuse_Anhui535",
        "max_workers": 5,
    },
}
...
def run_subset(subset: str, test_mode: bool) -> tuple[int, int]:
    ...
    print("=" * 60)
    print(f"Sec3_TransLearn2 — SeqRegLSTM Regional LOO translearn (Anhui{subset})")
