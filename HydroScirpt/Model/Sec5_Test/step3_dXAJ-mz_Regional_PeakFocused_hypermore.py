...
BASE_CONFIG = {
    "data_cfgs": {
        ...
        "output_dir": r"HydroScirpt/Result/Sec5_Test/dXAJ-mz_Regional",
        "basin_ids": None,
        "variables": {
    ...
    "training_cfgs": {
        ...
        "experiment_name": "dXAJ-mz_Regional_PF_h128_dr00_wu144_b0064_lr005_seed1111",
...
def main() -> None:
    ...
    print("=" * 60)
    print("Sec5 — dXAJ-mz RegionalTrain PeakFocused hyperparam sweep")
