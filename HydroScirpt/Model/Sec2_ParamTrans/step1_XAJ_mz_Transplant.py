...
from hydromodels_pbm.workflow.pipeline import run_transplant_experiment
...
BASE_CONFIG = {
    "data_cfgs": {
        ...
        "output_dir": r"HydroScirpt/Result/Sec2_ParamTrans/XAJ_mz_Transplant",
        "basin_ids": None,
        "variables": {
    ...
    "evaluation_cfgs": {
        ...
        "params_json": r"HydroScirpt/Result/Sec1_ModelPerf/XAJ_mz_Local/best_params_all.json",
...
def main() -> None:
    ...
    print("=" * 60)
    print("Sec2 — XAJ-mz parameter transplant")
    print(f"Output dir: {BASE_CONFIG['data_cfgs']['output_dir']}")
    print("-" * 60)

    run_transplant_experiment(BASE_CONFIG)
