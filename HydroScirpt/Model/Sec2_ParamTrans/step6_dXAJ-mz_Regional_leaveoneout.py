...
BASE_CONFIG = {
    "data_cfgs": {
        ...
        "output_dir": r"HydroScirpt/Result/Sec2_ParamTrans/dXAJ-mz_Train",
        "basin_ids": None,
        "variables": {
    ...
    "training_cfgs": {
        ...
        "experiment_name": (
            f"{PROJECT_PREFIX}_Anhui_50406910_without_h128_dr00_wu120_b0032_lr001_seed1111"
        ),
        "loss_function": "RMSE",
        "optimizer_name": "Adam",
        "learning_rate": 0.001,
...
def main() -> None:
    ...
    print("=" * 60)
    print("Sec2 — dXAJ-mz leave-one-basin-out regional train")
