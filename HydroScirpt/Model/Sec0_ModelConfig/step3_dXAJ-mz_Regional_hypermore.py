...
BASE_CONFIG = {
    "data_cfgs": {
        ...
        "output_dir": r"HydroScirpt/Result/Sec0_ModelConfig/dXAJ-mz_Regional",
        "basin_ids": None,
        "variables": {
    ...
    "training_cfgs": {
        ...
        "experiment_name": "dXAJ-mz_Regional_h128_dr00_wu144_b0064_lr005_seed1111",
        "loss_function": "RMSE",
        "optimizer_name": "Adam",
        "learning_rate": 0.05,
...
def main() -> None:
    ...
    print("=" * 60)
    print("Sec0 — dXAJ-mz RegionalTrain hyperparam sweep")
