...
TRANSLEARN_PREFIX = "SeqRegLSTM_LocalTransLearn"
...
BASE_CONFIG = {
    "data_cfgs": {
        ...
        "output_dir": r"HydroScirpt/Result/Sec4_Discussion/Sec3_TransLearn1/SeqRegLSTM_Local_TransLearn_extend",
        "basin_ids": None,
        "variables": {
...
def main() -> None:
    ...
    print("=" * 60)
    print("Sec4 — SeqRegLSTM Local similarity finetune (extend)")
