...
TRANSPLANT_PREFIX = "SeqRegLSTM_LocalTransplant"
...
BASE_CONFIG = {
    "data_cfgs": {
        ...
        "output_dir": r"HydroScirpt/Result/Sec4_Discussion/Sec2_ParamTrans/SeqRegLSTM_Local_Transplant_extend",
        "basin_ids": None,
        "variables": {
...
def main() -> None:
    ...
    print("=" * 60)
    print("Sec4 — SeqRegLSTM Local similarity transplant (extend)")
