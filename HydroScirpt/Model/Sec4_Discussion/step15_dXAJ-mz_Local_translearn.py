...
TRANSLEARN_PREFIX = "dXAJ-mz_LocalTransLearn"
...
BASE_CONFIG = {
    "data_cfgs": {
        ...
        "output_dir": r"HydroScirpt/Result/Sec4_Discussion/Sec3_TransLearn1/dXAJ-mz_Local_TransLearn_extend",
        "basin_ids": None,
        "variables": {
...
def main() -> None:
    ...
    print("=" * 60)
    print("Sec4 — dXAJ-mz Local similarity finetune (extend)")
