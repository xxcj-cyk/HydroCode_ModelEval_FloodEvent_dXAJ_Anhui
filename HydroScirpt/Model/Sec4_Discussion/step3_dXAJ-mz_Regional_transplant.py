...
TRANSPLANT_PREFIX = "dXAJ-mz_Transplant"
TRAIN_DIR = ROOT / "HydroScirpt/Result/Sec2_ParamTrans/dXAJ-mz_Train"
TOP9_CSV = (
    ROOT
...
BASE_CONFIG = {
    "data_cfgs": {
        ...
        "output_dir": r"HydroScirpt/Result/Sec4_Discussion/Sec2_ParamTrans/dXAJ-mz_Transplant_extend",
        "basin_ids": None,
        "variables": {
...
def main() -> None:
    ...
    print("=" * 60)
    print("Sec4 — dXAJ-mz leave-one-out direct transplant (extend)")
